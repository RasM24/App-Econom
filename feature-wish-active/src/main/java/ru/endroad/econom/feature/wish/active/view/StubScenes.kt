...
@Composable
internal fun RenderNoDesireStub(doTheMainAction: () -> Unit) = OneActionStub(
...
@Composable
internal fun RenderAllCompletedStub(doTheMainAction: () -> Unit, doTheSecondaryAction: () -> Unit) = TwoActionStub(
