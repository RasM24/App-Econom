...
import ru.endroad.tavern.assertions.check
import ru.endroad.tavern.assertions.text
import ru.endroad.tavern.assertions.visibility
...
class WishesListTest {
	...
	@get:Rule
	val activityActivityTestRule = ActivityTestRule(SingleActivity::class.java)
